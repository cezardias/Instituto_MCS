...
router.post('/', (req, res) => {
  ...
  try {
    ...
    `).run(
      ...
      parent_name || name, parent_email || email || null, parent_cpf || null, parent_rg || null, family_income || null, parents_profession || null, workplace || null, emergency_phone || null, emergency_phone_2 || null, family_kinship || null,
