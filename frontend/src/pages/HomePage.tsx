...
export default function HomePage() {
  return (
    <div className="bg-carbono text-marfim min-h-screen">
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative z-0">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/3] lg:aspect-[3/4] xl:aspect-[4/3]">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-carbono/80 to-transparent"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Stats Section */}
      <section className="border-t border-gray-800/50 bg-carbono pb-20 pt-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="text-center">
              ...
              <p className="font-serif text-4xl mb-2">+ 3.200</p>
            ...
            <div className="text-center">
              ...
              <p className="font-serif text-4xl mb-2">12</p>
              <p className="text-sm text-gray-400">Projetos em execução</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-serif text-4xl mb-2">07</p>
              <p className="text-sm text-gray-400">Municípios atendidos</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-serif text-4xl mb-2">23</p>
              <p className="text-sm text-gray-400">Parceiros institucionais</p>
            </div>

            <div className="col-span-2 lg:col-span-1 pl-0 lg:pl-8 lg:border-l border-gray-800/50 flex flex-col justify-center">
              ...
              <span className="text-xs font-semibold text-gray-400 uppercase tracking-widest">Instituto MCS</span>
            </div>
          </div>
        </div>
      </section>
