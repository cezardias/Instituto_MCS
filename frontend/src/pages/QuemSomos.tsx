  ...
  return (
    <div className="bg-marfim text-carbono min-h-screen">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="font-serif text-5xl lg:text-7xl leading-tight mb-8">
              Quem somos
            </h1>
            ...
            <div className="w-12 h-[1px] bg-dourado mt-10"></div>
          </div>
      ...
      <section className="py-20 border-t border-gray-200">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8 grid lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2">
            <span className="text-dourado font-semibold tracking-wider text-xs uppercase mb-2 block">
              NOSSOS PRINCÍPIOS
            </span>
            <h2 className="font-serif text-3xl mb-12">Missão, Visão e Valores</h2>
            
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                <div className="w-10 h-10 rounded-full border border-dourado flex items-center justify-center text-dourado mb-6">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                </div>
                <h3 className="font-bold mb-3">Missão</h3>
              ...
              <div>
                ...
                <h3 className="font-bold mb-3">Visão</h3>
                <p className="text-sm text-gray-600 leading-relaxed">
              ...
              <div>
                ...
                <h3 className="font-bold mb-3">Valores</h3>
                <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <div className="lg:border-l lg:border-gray-200 lg:pl-16">
            ...
            <Link to="/equipe" className="inline-flex items-center gap-2 border border-dourado text-dourado hover:bg-dourado hover:text-carbono transition-colors px-6 py-2 rounded-full text-xs font-bold tracking-widest uppercase">
      ...
      <section className="bg-[url('https://images.unsplash.com/photo-1542204165-65bf26472b9b?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center relative">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-8 py-20 text-marfim">
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            <div className="lg:col-span-2">
              <span className="text-dourado font-semibold tracking-wider text-xs uppercase mb-2 block">
                NOSSO IMPACTO
              </span>
              <h2 className="font-serif text-4xl">Números que movem mudanças</h2>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-serif text-3xl mb-1">+ 3.200</p>
              <p className="text-xs text-gray-400">Pessoas impactadas</p>
            </div>
            <div className="text-center">
              <div className="text-dourado mb-4 flex justify-center">
              ...
              <p className="text-xs text-gray-400">Projetos em execução</p>
            </div>
            <div className="text-center">
              <div className="text-dourado mb-4 flex justify-center">
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.243-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
              </div>
              <p className="font-serif text-3xl mb-1">07</p>
              <p className="text-xs text-gray-400">Municípios atendidos</p>
            </div>
          </div>
        </div>
      </section>
